...
SERVICE_TRANSLATION = {"identity":"Active Directory", "automation":"自动化", "backup":"备份", "cdn":"CDN", "cloud-services":"云服务", "event-hubs":"事件中心",
                       "hdinsight":"HDInsight", "media-services":"媒体服务", "mobile-services":"移动服务", "notification-hubs":"通知中心", "redis-cache":"Redis 缓存",
                       "scheduler":"计划程序", "service-bus":"服务总线", "site-recovery":"站点恢复", "sql-databases":"SQL 数据库", "storage":"存储", "traffic-manager":"流量管理器",
                       "virtual-machines":"虚拟机", "networking":"虚拟网络", "web-sites":"网站", "application-gateway":"应用程序网关","batch":"批处理",
                       "mysql":"MySQL Database on Azure","multi-factor-authentication":"多重身份验证", "expressroute":"ExpressRoute", "stream-analytics":"流分析"}
